...
import { CareMember ,SelectOption} from "types";
                    ...
                    <Col lg="6">
                      <SelectField 
                              ...
                              onChange={(selectionEvent:any) =>{
                                ...
                                let selections =selectionEvent.target.options as HTMLOptionsCollection 
                                let groupIdSelected = Array.from(selections).filter(option => option.selected).map(item =>parseInt(item.value));
