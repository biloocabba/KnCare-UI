...
export const memberTurnoverReport: TurnoverChart[] = [
...
export const workforceReport: Chart[] = [
...
export const distributionByGenderReport: Chart[] = [
  { label: "Male", value: 320 },
  { label: "Female", value: 306 },
];

export const distributionByRoleReport: Chart[] = [
...
export const distributionByBusinessUnitReport: Chart[] = [
...
export const distributionBySeniorityReport: Chart[] = [
...
export const distributionByAgeReport: Chart[] = [
