...
export const searchCareMembers = createAsyncThunk(
  "care-member/search",
  async (filters: any) => {
    console.log(filters);
...
export const updateCareMember = createAsyncThunk(
  ...
  async (updatedCareMember: IUpdated<CareMemberSaveRequest>): Promise<CareMember> => {
    const { data } = await careMemberService.updateCareMember(
      updatedCareMember,
    );
...
export const deleteCareMember = createAsyncThunk(
  "care-member/delete",
  async (id: number) => {
    let { data } = await careMemberService.deleteCareMember(id);
    return data;
  },
);
